...
const insertMainFontFace = () => {
    if (!hasStyle("data-ui5-font-face")) {
        createStyle(styleData$x, "data-ui5-font-face");
    }
};
const insertOverrideFontFace = () => {
    if (!hasStyle("data-ui5-font-face-override")) {
        createStyle(styleData$w, "data-ui5-font-face-override");
    }
};
...
const insertSystemCSSVars = () => {
    if (!hasStyle("data-ui5-system-css-vars")) {
        createStyle(styleData$v, "data-ui5-system-css-vars");
    }
};
...
function block0$l(context, tags, suffix) { return effectiveHtml `<button type="button" class="ui5-button-root" ?disabled="${this.disabled}" data-sap-focus-ref  @focusout=${this._onfocusout} @focusin=${this._onfocusin} @click=${this._onclick} @mousedown=${this._onmousedown} @mouseup=${this._onmouseup} @keydown=${this._onkeydown} @keyup=${this._onkeyup} @touchstart="${this._ontouchstart}" @touchend="${this._ontouchend}" tabindex=${l$1(this.tabIndexValue)} aria-expanded="${l$1(this.accessibilityAttributes.expanded)}" aria-controls="${l$1(this.accessibilityAttributes.controls)}" aria-haspopup="${l$1(this.accessibilityAttributes.hasPopup)}" aria-label="${l$1(this.ariaLabelText)}" title="${l$1(this.buttonTitle)}" part="button">${this.icon ? block1$g.call(this, context, tags, suffix) : undefined}<span id="${l$1(this._id)}-content" class="ui5-button-text"><bdi><slot></slot></bdi></span>${this.hasButtonType ? block2$f.call(this, context, tags, suffix) : undefined}</button> `; }
function block1$g(context, tags, suffix) { return suffix ? effectiveHtml `<${scopeTag("ui5-icon", tags, suffix)} class="ui5-button-icon" name="${l$1(this.icon)}" accessible-role="${l$1(this.iconRole)}" part="icon" ?show-tooltip=${this.showIconTooltip}></${scopeTag("ui5-icon", tags, suffix)}>` : effectiveHtml `<ui5-icon class="ui5-button-icon" name="${l$1(this.icon)}" accessible-role="${l$1(this.iconRole)}" part="icon" ?show-tooltip=${this.showIconTooltip}></ui5-icon>`; }
function block2$f(context, tags, suffix) { return effectiveHtml `<span class="ui5-hidden-text">${l$1(this.buttonTypeText)}</span>`; }

/* eslint no-unused-vars: 0 */
function block0$k(context, tags, suffix) { return effectiveHtml `<svg class="ui5-icon-root" part="root" tabindex="${l$1(this._tabIndex)}" dir="${l$1(this._dir)}" viewBox="${l$1(this.viewBox)}" role="${l$1(this.effectiveAccessibleRole)}" focusable="false" preserveAspectRatio="xMidYMid meet" aria-label="${l$1(this.effectiveAccessibleName)}" aria-hidden=${l$1(this.effectiveAriaHidden)} xmlns="http://www.w3.org/2000/svg" @focusin=${this._onfocusin} @focusout=${this._onfocusout} @keydown=${this._onkeydown} @keyup=${this._onkeyup}>${blockSVG1$2.call(this, context, tags, suffix)}</svg>`; }
function block1$f(context, tags, suffix) { return effectiveSvg `<title id="${l$1(this._id)}-tooltip">${l$1(this.effectiveAccessibleName)}</title>`; }
function block2$e(context, tags, suffix) { return effectiveSvg `${l$1(this.customSvg)}`; }
function block3$c(context, tags, suffix, item, index) { return effectiveSvg `<path d="${l$1(item)}"></path>`; }
function blockSVG1$2(context, tags, suffix) {
    return effectiveSvg `${this.hasIconTooltip ? block1$f.call(this, context, tags, suffix) : undefined}<g role="presentation">${this.customSvg ? block2$e.call(this, context, tags, suffix) : undefined}${c(this.pathData, (item, index) => item._id || index, (item, index) => block3$c.call(this, context, tags, suffix, item, index))}</g>`;
}
...
BusyIndicator = BusyIndicator_1 = __decorate$g([
    customElement({
...
/* eslint no-unused-vars: 0 */
function block0$h(context, tags, suffix) { return effectiveHtml `<div class="${o$2(this.classes.root)}" @focusin="${this._onfocusin}" @keydown="${this._onkeydown}" @ui5-_press=${l$1(this.onItemPress)} @ui5-close=${l$1(this.onItemClose)} @ui5-toggle=${l$1(this.onItemToggle)} @ui5-_request-tabindex-change=${l$1(this.onItemTabIndexChange)} @ui5-_focused=${l$1(this.onItemFocused)} @ui5-_forward-after=${l$1(this.onForwardAfter)} @ui5-_forward-before=${l$1(this.onForwardBefore)} @ui5-_selection-requested=${l$1(this.onSelectionRequested)} @ui5-_focus-requested=${l$1(this.onFocusRequested)}><div class="ui5-list-scroll-container">${this.header.length ? block1$d.call(this, context, tags, suffix) : undefined}${this.shouldRenderH1 ? block2$c.call(this, context, tags, suffix) : undefined}${this.hasData ? block3$a.call(this, context, tags, suffix) : undefined}<span id="${l$1(this._id)}-modeLabel" class="ui5-hidden-text">${l$1(this.ariaLabelModeText)}</span><ul id="${l$1(this._id)}-listUl" class="ui5-list-ul" role="${l$1(this.accessibleRole)}" aria-label="${l$1(this.ariaLabelTxt)}" aria-labelledby="${l$1(this.ariaLabelledBy)}" aria-roledescription="${l$1(this.accessibleRoleDescription)}"><slot></slot>${this.showNoDataText ? block4$9.call(this, context, tags, suffix) : undefined}</ul>${this.growsWithButton ? block5$7.call(this, context, tags, suffix) : undefined}${this.footerText ? block6$5.call(this, context, tags, suffix) : undefined}${this.hasData ? block7$4.call(this, context, tags, suffix) : undefined}<span tabindex="-1" aria-hidden="true" class="ui5-list-end-marker"></span></div>${this.busy ? block8$4.call(this, context, tags, suffix) : undefined}</div> `; }
function block1$d(context, tags, suffix) { return effectiveHtml `<slot name="header" />`; }
function block2$c(context, tags, suffix) { return effectiveHtml `<header id="${l$1(this.headerID)}" class="ui5-list-header">${l$1(this.headerText)}</header>`; }
function block3$a(context, tags, suffix) { return effectiveHtml `<div id="${l$1(this._id)}-before" tabindex="0" role="none" class="ui5-list-focusarea"></div>`; }
function block4$9(context, tags, suffix) { return effectiveHtml `<li id="${l$1(this._id)}-nodata" class="ui5-list-nodata"><div id="${l$1(this._id)}-nodata-text" class="ui5-list-nodata-text">${l$1(this.noDataText)}</div></li>`; }
function block5$7(context, tags, suffix) { return effectiveHtml `<div growing-button><div tabindex="0" role="button" id="${l$1(this._id)}-growing-btn" aria-labelledby="${l$1(this._id)}-growingButton-text" ?active="${this._loadMoreActive}" @click="${this._onLoadMoreClick}" @keydown="${this._onLoadMoreKeydown}" @keyup="${this._onLoadMoreKeyup}" @mousedown="${this._onLoadMoreMousedown}" @mouseup="${this._onLoadMoreMouseup}" growing-button-inner><span id="${l$1(this._id)}-growingButton-text" growing-button-text>${l$1(this._growingButtonText)}</span></div></div>`; }
...
CheckBox = CheckBox_1 = __decorate$f([
    customElement({
        tag: "ui5-checkbox",
        languageAware: true,
        renderer: litRender,
...
/* eslint no-unused-vars: 0 */
function block0$f(context, tags, suffix) { return effectiveHtml `<div class="ui5-radio-root" role="radio" aria-checked="${l$1(this.checked)}" aria-disabled="${l$1(this.effectiveAriaDisabled)}" aria-describedby="${l$1(this.effectiveAriaDescribedBy)}" aria-label="${l$1(this.ariaLabelText)}" tabindex="${l$1(this.effectiveTabIndex)}" @click="${this._onclick}" @keydown="${this._onkeydown}" @keyup="${this._onkeyup}" @mousedown="${this._onmousedown}" @mouseup="${this._onmouseup}" @focusout="${this._onfocusout}"><div class='ui5-radio-inner ${o$2(this.classes.inner)}'><svg class="ui5-radio-svg" focusable="false" aria-hidden="true">${blockSVG1$1.call(this, context, tags, suffix)}</svg><input type='radio' ?required="${this.required}" ?checked="${this.checked}" ?readonly="${this.readonly}" ?disabled="${this.effectiveAriaDisabled}" name="${l$1(this.name)}"  data-sap-no-tab-ref/></div>${this.text ? block1$b.call(this, context, tags, suffix) : undefined}${this.hasValueState ? block2$a.call(this, context, tags, suffix) : undefined}<slot name="formSupport"></slot></div>`; }
...
function block2$a(context, tags, suffix) { return effectiveHtml `<span id="${l$1(this._id)}-descr" class="ui5-hidden-text">${l$1(this.valueStateText)}</span>`; }
...
RadioButton = RadioButton_1 = __decorate$e([
    customElement({
...
List = List_1 = __decorate$d([
    customElement({
        tag: "ui5-list",
        fastNavigation: true,
        renderer: litRender,
        template: block0$h,
        styles: [styleData$m, styleData$n],
...
ListItem = ListItem_1 = __decorate$c([
    customElement({
        languageAware: true,
        styles: [ListItemBase$1.styles, styleData$j],
        dependencies: [
            Button$1,
            RadioButton$1,
            CheckBox$1,
...
/* eslint no-unused-vars: 0 */
function block0$e(context, tags, suffix) { return effectiveHtml `${this.h1 ? block1$a.call(this, context, tags, suffix) : undefined}${this.h2 ? block2$9.call(this, context, tags, suffix) : undefined}${this.h3 ? block3$8.call(this, context, tags, suffix) : undefined}${this.h4 ? block4$8.call(this, context, tags, suffix) : undefined}${this.h5 ? block5$6.call(this, context, tags, suffix) : undefined}${this.h6 ? block6$4.call(this, context, tags, suffix) : undefined}`; }
function block1$a(context, tags, suffix) { return effectiveHtml `<h1 class="ui5-title-root"><span id="${l$1(this._id)}-inner"><slot></slot></span></h1>`; }
function block2$9(context, tags, suffix) { return effectiveHtml `<h2 class="ui5-title-root"><span id="${l$1(this._id)}-inner"><slot></slot></span></h2>`; }
function block3$8(context, tags, suffix) { return effectiveHtml `<h3 class="ui5-title-root"><span id="${l$1(this._id)}-inner"><slot></slot></span></h3>`; }
function block4$8(context, tags, suffix) { return effectiveHtml `<h4 class="ui5-title-root"><span id="${l$1(this._id)}-inner"><slot></slot></span></h4>`; }
function block5$6(context, tags, suffix) { return effectiveHtml `<h5 class="ui5-title-root"><span id="${l$1(this._id)}-inner"><slot></slot></span></h5>`; }
...
/* eslint no-unused-vars: 0 */
function block0$b(context, tags, suffix) { return effectiveHtml `<section style="${styleMap(this.styles.root)}" class="${o$2(this.classes.root)}" role="${l$1(this._role)}" aria-modal="${l$1(this._ariaModal)}" aria-label="${l$1(this._ariaLabel)}" aria-labelledby="${l$1(this._ariaLabelledBy)}" @keydown=${this._onkeydown} @focusout=${this._onfocusout} @mouseup=${this._onmouseup} @mousedown=${this._onmousedown}><span class="first-fe" data-ui5-focus-trap tabindex="0" @focusin=${this.forwardToLast}></span><span class="ui5-popover-arrow" style="${styleMap(this.styles.arrow)}"></span>${this._displayHeader ? block1$9.call(this, context, tags, suffix) : undefined}<div style="${styleMap(this.styles.content)}" class="${o$2(this.classes.content)}"  @scroll="${this._scroll}" part="content"><slot></slot></div>${this._displayFooter ? block4$7.call(this, context, tags, suffix) : undefined}<span class="last-fe" data-ui5-focus-trap tabindex="0" @focusin=${this.forwardToFirst}></span></section> `; }
function block1$9(context, tags, suffix) { return effectiveHtml `<header class="ui5-popup-header-root" id="ui5-popup-header" part="header">${this.header.length ? block2$8.call(this, context, tags, suffix) : block3$7.call(this, context, tags, suffix)}</header>`; }
function block2$8(context, tags, suffix) { return effectiveHtml `<slot name="header"></slot>`; }
function block3$7(context, tags, suffix) { return effectiveHtml `<h1 class="ui5-popup-header-text">${l$1(this.headerText)}</h1>`; }
function block4$7(context, tags, suffix) { return effectiveHtml `${this.footer.length ? block5$5.call(this, context, tags, suffix) : undefined}`; }
...
Popover = Popover_1 = __decorate$9([
    customElement({
        tag: "ui5-popover",
        styles: [
            styleData$m,
...
/* eslint no-unused-vars: 0 */
function block0$a(context, tags, suffix) { return effectiveHtml `<div class="ui5-input-root ui5-input-focusable-element" @focusin="${this._onfocusin}" @focusout="${this._onfocusout}"><div class="ui5-input-content"><input id="${l$1(this._id)}-inner" class="ui5-input-inner" style="${styleMap(this.styles.innerInput)}" type="${l$1(this.inputType)}" inner-input ?inner-input-with-icon="${this.icon.length}" ?disabled="${this.disabled}" ?readonly="${this._readonly}" .value="${l$1(this._innerValue)}" placeholder="${l$1(this._placeholder)}" maxlength="${l$1(this.maxlength)}" role="${l$1(this.accInfo.input.role)}" aria-controls="${l$1(this.accInfo.input.ariaControls)}" aria-invalid="${l$1(this.accInfo.input.ariaInvalid)}" aria-haspopup="${l$1(this.accInfo.input.ariaHasPopup)}" aria-describedby="${l$1(this.accInfo.input.ariaDescribedBy)}" aria-roledescription="${l$1(this.accInfo.input.ariaRoledescription)}" aria-autocomplete="${l$1(this.accInfo.input.ariaAutoComplete)}" aria-expanded="${l$1(this.accInfo.input.ariaExpanded)}" aria-label="${l$1(this.accInfo.input.ariaLabel)}" aria-required="${l$1(this.required)}" @input="${this._handleInput}" @change="${this._handleChange}" @keydown="${this._onkeydown}" @keyup="${this._onkeyup}" @click=${this._click} @focusin=${this.innerFocusIn} data-sap-focus-ref step="${l$1(this.nativeInputAttributes.step)}" min="${l$1(this.nativeInputAttributes.min)}" max="${l$1(this.nativeInputAttributes.max)}" />${this.effectiveShowClearIcon ? block1$8.call(this, context, tags, suffix) : undefined}${this.icon.length ? block2$7.call(this, context, tags, suffix) : undefined}<div class="ui5-input-value-state-icon">${o$1(this._valueStateInputIcon)}</div>${this.showSuggestions ? block3$6.call(this, context, tags, suffix) : undefined}${this.accInfo.input.ariaDescription ? block4$6.call(this, context, tags, suffix) : undefined}${this.hasValueState ? block5$4.call(this, context, tags, suffix) : undefined}</div><slot name="formSupport"></slot></div>`; }
function block1$8(context, tags, suffix) { return suffix ? effectiveHtml `<div @click=${this._clear} @mousedown=${this._iconMouseDown} class="ui5-input-clear-icon-wrapper" input-icon tabindex="-1"><${scopeTag("ui5-icon", tags, suffix)} tabindex="-1" class="ui5-input-clear-icon" name="decline" accessible-name="${l$1(this.clearIconAccessibleName)}"></${scopeTag("ui5-icon", tags, suffix)}></div>` : effectiveHtml `<div @click=${this._clear} @mousedown=${this._iconMouseDown} class="ui5-input-clear-icon-wrapper" input-icon tabindex="-1"><ui5-icon tabindex="-1" class="ui5-input-clear-icon" name="decline" accessible-name="${l$1(this.clearIconAccessibleName)}"></ui5-icon></div>`; }
function block2$7(context, tags, suffix) { return effectiveHtml `<div class="ui5-input-icon-root"><slot name="icon"></slot></div>`; }
function block3$6(context, tags, suffix) { return effectiveHtml `<span id="${l$1(this._id)}-suggestionsText" class="ui5-hidden-text">${l$1(this.suggestionsText)}</span><span id="${l$1(this._id)}-selectionText" class="ui5-hidden-text" aria-live="polite" role="status"></span><span id="${l$1(this._id)}-suggestionsCount" class="ui5-hidden-text" aria-live="polite">${l$1(this.availableSuggestionsCount)}</span>`; }
function block4$6(context, tags, suffix) { return effectiveHtml `<span id="${l$1(this._id)}-descr" class="ui5-hidden-text">${l$1(this.accInfo.input.ariaDescription)}</span>`; }
function block5$4(context, tags, suffix) { return effectiveHtml `<span id="${l$1(this._id)}-valueStateDesc" class="ui5-hidden-text">${l$1(this.ariaValueStateHiddenText)}</span>`; }

/* eslint no-unused-vars: 0 */
function block0$9(context, tags, suffix) { return effectiveHtml `${this.showSuggestions ? block1$7.call(this, context, tags, suffix) : undefined}${this.hasValueStateMessage ? block17$2.call(this, context, tags, suffix) : undefined} `; }
function block1$7(context, tags, suffix) { return suffix ? effectiveHtml `<${scopeTag("ui5-responsive-popover", tags, suffix)} class="${o$2(this.classes.popover)}" hide-arrow _disable-initial-focus placement-type="Bottom" horizontal-align="Left" style="${styleMap(this.styles.suggestionsPopover)}" @ui5-after-open="${l$1(this._afterOpenPopover)}" @ui5-after-close="${l$1(this._afterClosePopover)}" @ui5-scroll="${l$1(this._scroll)}">${this._isPhone ? block2$6.call(this, context, tags, suffix) : undefined}${!this._isPhone ? block7$3.call(this, context, tags, suffix) : undefined}<${scopeTag("ui5-list", tags, suffix)} separators="${l$1(this.suggestionSeparators)}" @mousedown="${this.onItemMouseDown}" mode="SingleSelect">${c(this.suggestionObjects, (item, index) => item._id || index, (item, index) => block12$2.call(this, context, tags, suffix, item, index))}</${scopeTag("ui5-list", tags, suffix)}>${this._isPhone ? block16$2.call(this, context, tags, suffix) : undefined}</${scopeTag("ui5-responsive-popover", tags, suffix)}>` : effectiveHtml `<ui5-responsive-popover class="${o$2(this.classes.popover)}" hide-arrow _disable-initial-focus placement-type="Bottom" horizontal-align="Left" style="${styleMap(this.styles.suggestionsPopover)}" @ui5-after-open="${l$1(this._afterOpenPopover)}" @ui5-after-close="${l$1(this._afterClosePopover)}" @ui5-scroll="${l$1(this._scroll)}">${this._isPhone ? block2$6.call(this, context, tags, suffix) : undefined}${!this._isPhone ? block7$3.call(this, context, tags, suffix) : undefined}<ui5-list separators="${l$1(this.suggestionSeparators)}" @mousedown="${this.onItemMouseDown}" mode="SingleSelect">${c(this.suggestionObjects, (item, index) => item._id || index, (item, index) => block12$2.call(this, context, tags, suffix, item, index))}</ui5-list>${this._isPhone ? block16$2.call(this, context, tags, suffix) : undefined}</ui5-responsive-popover>`; }
function block2$6(context, tags, suffix) { return suffix ? effectiveHtml `<div slot="header" class="ui5-responsive-popover-header"><div class="row"><span>${l$1(this._headerTitleText)}</span><${scopeTag("ui5-button", tags, suffix)} class="ui5-responsive-popover-close-btn" icon="decline" design="Transparent" @click="${this._closeRespPopover}"></${scopeTag("ui5-button", tags, suffix)}></div><div class="row"><div class="input-root-phone native-input-wrapper"><${scopeTag("ui5-input", tags, suffix)} class="ui5-input-inner-phone" type="${l$1(this.inputType)}" .value="${l$1(this.value)}" ?show-clear-icon=${this.showClearIcon} placeholder="${l$1(this.placeholder)}" @ui5-input="${l$1(this._handleInput)}" @ui5-change="${l$1(this._handleChange)}"></${scopeTag("ui5-input", tags, suffix)}></div></div></div>${this.hasValueStateMessage ? block3$5.call(this, context, tags, suffix) : undefined}` : effectiveHtml `<div slot="header" class="ui5-responsive-popover-header"><div class="row"><span>${l$1(this._headerTitleText)}</span><ui5-button class="ui5-responsive-popover-close-btn" icon="decline" design="Transparent" @click="${this._closeRespPopover}"></ui5-button></div><div class="row"><div class="input-root-phone native-input-wrapper"><ui5-input class="ui5-input-inner-phone" type="${l$1(this.inputType)}" .value="${l$1(this.value)}" ?show-clear-icon=${this.showClearIcon} placeholder="${l$1(this.placeholder)}" @ui5-input="${l$1(this._handleInput)}" @ui5-change="${l$1(this._handleChange)}"></ui5-input></div></div></div>${this.hasValueStateMessage ? block3$5.call(this, context, tags, suffix) : undefined}`; }
function block3$5(context, tags, suffix) { return suffix ? effectiveHtml `<div class="${o$2(this.classes.popoverValueState)}" style="${styleMap(this.styles.suggestionPopoverHeader)}"><${scopeTag("ui5-icon", tags, suffix)} class="ui5-input-value-state-message-icon" name="${l$1(this._valueStateMessageInputIcon)}"></${scopeTag("ui5-icon", tags, suffix)}>${this.shouldDisplayDefaultValueStateMessage ? block4$5.call(this, context, tags, suffix) : block5$3.call(this, context, tags, suffix)}</div>` : effectiveHtml `<div class="${o$2(this.classes.popoverValueState)}" style="${styleMap(this.styles.suggestionPopoverHeader)}"><ui5-icon class="ui5-input-value-state-message-icon" name="${l$1(this._valueStateMessageInputIcon)}"></ui5-icon>${this.shouldDisplayDefaultValueStateMessage ? block4$5.call(this, context, tags, suffix) : block5$3.call(this, context, tags, suffix)}</div>`; }
function block4$5(context, tags, suffix) { return effectiveHtml `${l$1(this.valueStateText)}`; }
function block5$3(context, tags, suffix) { return effectiveHtml `${c(this.valueStateMessageText, (item, index) => item._id || index, (item, index) => block6$3.call(this, context, tags, suffix, item, index))}`; }
...
Input = Input_1 = __decorate$8([
    customElement({
        ...
        styles: styleData$c,
        staticAreaStyles: [styleData$b, styleData$a, styleData$9],
        get dependencies() {
            const Suggestions = getFeature("InputSuggestions");
...
/* eslint no-unused-vars: 0 */
function block0$8(context, tags, suffix) { return effectiveHtml `<div class="${o$2(this.classes.root)}" id="${l$1(this._id)}" role="note" aria-live="assertive" aria-labelledby="${l$1(this._id)}">${!this.hideIcon ? block1$6.call(this, context, tags, suffix) : undefined}<span class="ui5-hidden-text">${l$1(this.hiddenText)}</span><span class="ui5-message-strip-text"><slot></slot></span>${!this.hideCloseButton ? block4$4.call(this, context, tags, suffix) : undefined}</div>`; }
function block1$6(context, tags, suffix) { return effectiveHtml `<div class="ui5-message-strip-icon-wrapper" aria-hidden="true">${this.iconProvided ? block2$5.call(this, context, tags, suffix) : block3$4.call(this, context, tags, suffix)}</div>`; }
function block2$5(context, tags, suffix) { return effectiveHtml `<slot name="icon"></slot>`; }
function block3$4(context, tags, suffix) { return suffix ? effectiveHtml `<${scopeTag("ui5-icon", tags, suffix)} name="${l$1(this.standardIconName)}" class="ui5-message-strip-icon"></${scopeTag("ui5-icon", tags, suffix)}>` : effectiveHtml `<ui5-icon name="${l$1(this.standardIconName)}" class="ui5-message-strip-icon"></ui5-icon>`; }
function block4$4(context, tags, suffix) { return suffix ? effectiveHtml `<${scopeTag("ui5-button", tags, suffix)} icon="decline" design="Transparent" class="ui5-message-strip-close-button" tooltip="${l$1(this._closeButtonText)}" @click=${this._closeClick}></${scopeTag("ui5-button", tags, suffix)}>` : effectiveHtml `<ui5-button icon="decline" design="Transparent" class="ui5-message-strip-close-button" tooltip="${l$1(this._closeButtonText)}" @click=${this._closeClick}></ui5-button>`; }
...
MessageStrip = MessageStrip_1 = __decorate$7([
    customElement({
...
/* eslint no-unused-vars: 0 */
function block0$7(context, tags, suffix) { return effectiveHtml `<section style="${styleMap(this.styles.root)}" class="${o$2(this.classes.root)}" role="${l$1(this._role)}" aria-modal="${l$1(this._ariaModal)}" aria-label="${l$1(this._ariaLabel)}" aria-labelledby="${l$1(this._ariaLabelledBy)}" @keydown=${this._onkeydown} @focusout=${this._onfocusout} @mouseup=${this._onmouseup} @mousedown=${this._onmousedown}><span class="first-fe" data-ui5-focus-trap tabindex="0" @focusin=${this.forwardToLast}></span>${this._displayHeader ? block1$5.call(this, context, tags, suffix) : undefined}<div style="${styleMap(this.styles.content)}" class="${o$2(this.classes.content)}"  @scroll="${this._scroll}" part="content"><slot></slot></div>${this.footer.length ? block10$2.call(this, context, tags, suffix) : undefined}${this._showResizeHandle ? block11$2.call(this, context, tags, suffix) : undefined}<span class="last-fe" data-ui5-focus-trap tabindex="0" @focusin=${this.forwardToFirst}></span></section> `; }
function block1$5(context, tags, suffix) { return effectiveHtml `<header><div class="ui5-popup-header-root" id="ui5-popup-header" role="group" aria-describedby=${l$1(this.effectiveAriaDescribedBy)} aria-roledescription=${l$1(this.ariaRoleDescriptionHeaderText)} tabindex="${l$1(this._headerTabIndex)}" @keydown="${this._onDragOrResizeKeyDown}" @mousedown="${this._onDragMouseDown}" part="header" state="${l$1(this.state)}">${this.hasValueState ? block2$4.call(this, context, tags, suffix) : undefined}${this.header.length ? block3$3.call(this, context, tags, suffix) : block4$3.call(this, context, tags, suffix)}${this.resizable ? block5$2.call(this, context, tags, suffix) : block8$2.call(this, context, tags, suffix)}</div></header>`; }
function block2$4(context, tags, suffix) { return suffix ? effectiveHtml `<${scopeTag("ui5-icon", tags, suffix)} class="ui5-dialog-value-state-icon" name="${l$1(this._dialogStateIcon)}"></${scopeTag("ui5-icon", tags, suffix)}>` : effectiveHtml `<ui5-icon class="ui5-dialog-value-state-icon" name="${l$1(this._dialogStateIcon)}"></ui5-icon>`; }
function block3$3(context, tags, suffix) { return effectiveHtml `<slot name="header"></slot>`; }
function block4$3(context, tags, suffix) { return effectiveHtml `<h1 id="ui5-popup-header-text" class="ui5-popup-header-text">${l$1(this.headerText)}</h1>`; }
function block5$2(context, tags, suffix) { return effectiveHtml `${this.draggable ? block6$2.call(this, context, tags, suffix) : block7$2.call(this, context, tags, suffix)}`; }
